...
## 5. สถานะไฟ LED, Buzzer และ ปุ่มปิดเสียง/ปุ่มเครือข่าย
...
| **Mute Switch (Physical Button)**| **GPIO 23** | **Pin 16** | ปุ่มกดปิดเสียงฮาร์ดแวร์ ต่อสวิตช์แบบกดติด-ปล่อยดับ/ลอค ระหว่างขานี้กับ GND |
| **Wi-Fi / Hotspot Toggle Switch**| **GPIO 16** | **Pin 36** | ปุ่มสลับโหมดเครือข่ายระหว่างเชื่อมต่อ Wi-Fi ภายนอก กับ ปล่อย Hotspot (ต่อลง GND ขา 34) |
